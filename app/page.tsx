  ...
  return (
    <div className="overflow-clip inset-0 -z-10 h-full w-full bg-[#fafafa] bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
      ...
      >
        ...
        <div className="flex items-centergap-x-4 ">
          <a href="tel:6645480005" className="hidden lg:flex ">
            <button className="px-4 py-2 rounded-md flex items-center gap-x-3"></button>
          </a>
      ...
      <main className="mx:pb-10">
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[66%] md:mx-auto mt-14">
          ...
          <p className="md:text-center text-xl md:text-2xl my-6 md:my-10 md:w-4/5 mx-auto text-gray-500 ">
            Schedule a call with us to discuss the right path for yourself in
            minutes
          </p>
      ...
      <div className="flex flex-col items-center justify-center  h-full text-center px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <a
          href="https://prospera-carrer-buddy.vercel.app/"
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;As the founder of The Doon School, Dehradun, I am genuinely
              impressed with Prospera&apos;s Career Counselling and Guidance
              App. Their student counselling program stands out for its
              exceptional interactiveness and expert-level insights.
              Prospera&apos;s profound expertise and innovative approach in
              guiding students through their career choices reflect a remarkable
              commitment to excellence. Their dedication to providing top-notch
              educational support truly sets them apart in shaping the future of
              young minds. &quot;
            </h1>
      ...
      <Element name="experts">
        <main className="md:px-0 mx-6  md:mx-auto">
          ...
          <div className="flex flex-col items-center justify-center  h-full text-center px-2 sm:px-4 md:px-6 lg:px-8"></div>
      ...
      <div className="flex flex-col items-center justify-center  h-full text-center px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <a
          href="https://prospera-ai-chatbot.vercel.app/"
          className="inline-block px-4 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 sm:px-6 sm:py-3 md:px-8 md:py-4"
          target="_blank"
          rel="noopener noreferrer"
        >
